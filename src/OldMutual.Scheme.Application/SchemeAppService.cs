...
public class SchemeAppService : ApplicationService, ISchemeAppService
{
    ...
    public async Task<Tuple<bool>> InsertSchemeAsync_Bulk(List<Inbound_Scheme_BillGroups> input)
    {
        List<Inbound_Mimo_Customer> lstInbound_Mimo_Customer = new List<Inbound_Mimo_Customer>();
        ...
        return new Tuple<bool>(tuple.Item1);
    }

    public async Task<SchemeResponse> InsertSchemeAsync_ADO(List<Inbound_Scheme_BillGroups> input)
    {
        ...
        schemeResponse.Message = tuple.Item2;
        schemeResponse.StatusCode = tuple.Item3;
